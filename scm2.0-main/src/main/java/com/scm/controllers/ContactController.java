...
public class ContactController {
    ...
    public String addContactView(Model model, Authentication authentication) {
        ...
        if (user == null) return "verify-email-notice"; // redirect if not verified
    ...
    public String saveContact(@Valid @ModelAttribute ContactForm contactForm, BindingResult result,
        ...
        User user = getVerifiedUser(authentication, model);
        if (user == null) return "verify-email-notice";
    ...
    // helper method to check if user exists and email verified
